...
_trigger setVariable [format ["%1_buildPop_buildingPopulationArray",PREFIXQUOTED],[_trigger,_side,_unitPool,_unitCount,_enableDynamicSimulation,_bPosBlacklist]];
